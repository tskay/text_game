...
export const IMAGE_PROMPT = `A digital art illustration for a text adventure game about UN SDG7 (Affordable and Clean Energy). The scene depicts: {storyExcerpt}. Emphasize hope, innovation, and community action towards sustainable energy. Style: vibrant, detailed, slightly stylized, optimistic. Do not include any text, captions, or labels in the image.`;
